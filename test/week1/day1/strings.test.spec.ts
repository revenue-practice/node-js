...
import { isPalindrome, reverseWords, titleCase } from '../../../src/week1/day1/drills';
...
test('Reverse words', () => {
    ...
    expect(reverseWords('hello I     am     Ankit')).toStrictEqual('Ankit am I hello');
    expect(reverseWords('   ')).toStrictEqual('');
});

test('Title case', () => {
    expect(titleCase('hello  i   am  the World')).toStrictEqual('Hello I Am The World');
